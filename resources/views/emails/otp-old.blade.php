                    ...
                    <table
                        ...
                        <tr>
                            <td
                                ...
                                <p>Thank you for choosing {{ env('APP_NAME') }}. <br> Please use the verification code below to complete your registration. This code is valid for 10 minutes:</p>
                                <br>
                                <p><span style="margin-bottom: 20px; background: #3cbf5f; padding: 10px 20px; color: #fff; font-size: 14px; font-weight: bold; text-decoration: none;">
                                    {{ $otp }}
                                </span></p>
                                <br>
                                ...
                                <p style="line-height: 28px;margin: 0 0 20px 0;">
                                    <strong>{{ env('APP_NAME') }} App Team</strong><br />
                                    {{-- The  Team --}}
                                </p>
                            </td>
                        </tr>
