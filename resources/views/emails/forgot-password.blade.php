...
<head>
  <meta charset="UTF-8">
  <title>{{ env('APP_NAME') }} - Welcome to Homee</title>
</head>
              ...
              <table border="0" cellspacing="0" cellpadding="0" width="100%">
                ...
                <tr>
                  <td align="center" style="font-size:16px; color:#555555; line-height:1.6;">
                    Thanks for signing up with <strong>Homee</strong> — your smarter way to find the perfect housemates and rooms.
                    <br><br>
                    Please use the code below to complete your registration (valid for <strong>10 minutes</strong>):
                  </td>
                </tr>
              </table>
